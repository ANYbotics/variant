 ...
 */
class NullPointerException : public ros::Exception {
 public:
 ...
 */
class InvalidOperationException : public ros::Exception {
 public:
  /** \brief Default constructor
   */
 ...
 */
class InvalidDataTypeException : public ros::Exception {
 public:
  /** \brief Default constructor
   */
 ...
 */
class ImmutableDataTypeException : public ros::Exception {
 public:
  /** \brief Default constructor
   */
 ...
 */
class NoSuchDataTypeException : public ros::Exception {
 public:
  /** \brief Constructor
   */
 ...
 */
class AmbiguousDataTypeIdentifierException : public ros::Exception {
 public:
  /** \brief Constructor
   */
 ...
 */
class DataTypeMismatchException : public ros::Exception {
 public:
  /** \brief Constructor
   */
 ...
 */
class AmbiguousMemberNameException : public ros::Exception {
 public:
  /** \brief Constructor
   */
 ...
 */
class NoSuchMemberException : public ros::Exception {
 public:
 ...
 */
class InvalidMessageMemberException : public ros::Exception {
 public:
  /** \brief Default constructor
   */
 ...
 */
class MD5SumMismatchException : public ros::Exception {
 public:
  /** \brief Constructor
   */
 ...
 */
class InvalidMessageTypeException : public ros::Exception {
 public:
  /** \brief Constructor
   */
 ...
 */
class MessageTypeMismatchException : public ros::Exception {
 public:
  /** \brief Constructor
   */
 ...
 *   definition
 */
class DefinitionParseException : public ros::Exception {
 public:
  /** \brief Constructor
   */
 ...
 */
class PackageNotFoundException : public ros::Exception {
 public:
  /** \brief Constructor
   */
 ...
 */
class FileOpenException : public ros::Exception {
 public:
  /** \brief Constructor
   */
 ...
 */
class InvalidSerializerException : public ros::Exception {
 public:
  /** \brief Default constructor
   */
