 ...
 */
class MessageVariant : public CollectionVariant {
 ...
 protected:
  ...
  class ValueImplV : public Value {
   public:
     ...
     */
    const std::string& getMemberName(int index) const override;
   ...
   */
  template <typename T>
  class ValueImplT : public Variant::ValueT<typename type_traits::MessageType<T>::ValueType>, public Value {
   public:
    ...
    /** \brief Default constructor
     */
    ValueImplT(const MessageFieldCollection<MessageVariable>& members = MessageFieldCollection<MessageVariable>(),
