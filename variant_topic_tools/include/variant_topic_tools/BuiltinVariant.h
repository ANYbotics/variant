 ...
 */
class BuiltinVariant : public Variant {
 ...
 protected:
   ...
   */
  class Value : public virtual Variant::Value {
   public:
    /** \brief Default constructor
     */
    Value();
   ...
   */
  template <typename T>
  class ValueImplT : public Variant::ValueT<typename type_traits::BuiltinType<T>::ValueType>, public Value {
   public:
     ...
     */
    void setValue(const Variant::Value& value) override;
     ...
     *   (implementation)
     */
    bool isEqual(const Variant::Value& value) const override;
  ...
  static double getNumericValue(
      ...
      typename boost::enable_if<
          boost::type_traits::ice_or<boost::is_base_of<ros::Duration, T>::value, boost::is_base_of<ros::Time, T>::value> >::type* /*unused*/
      = 0);
  ...
  template <typename T>
  static double getNumericValue(
      const T& value, typename boost::enable_if<typename type_traits::BuiltinType<T>::IsNumeric>::type* /*unused*/ = 0,
   ...
   */
  template <typename T>
  static double getNumericValue(const T& value,
                                typename boost::disable_if<typename type_traits::BuiltinType<T>::IsNumeric>::type* /*unused*/ = 0);
  ...
  static bool isEqual(
      ...
      typename boost::enable_if<boost::has_equal_to<typename type_traits::BuiltinType<T>::ValueType,
                                                    typename type_traits::BuiltinType<T>::ValueType, bool> >::type* /*unused*/
      = 0);
   ...
   */
  template <typename T>
  static void read(std::istream& stream, typename type_traits::BuiltinType<T>::ValueType& value,
                   typename boost::enable_if<boost::is_same<T, bool> >::type* /*unused*/ = 0);
  ...
  static void read(
      ...
      typename boost::disable_if<boost::is_same<T, bool> >::type* /*unused*/ = 0,
      typename boost::enable_if<boost::has_right_shift<std::istream, typename type_traits::BuiltinType<T>::ValueType&> >::type* /*unused*/
      = 0);
  ...
  static void read(
      std::istream& stream, typename type_traits::BuiltinType<T>::ValueType& value,
      typename boost::disable_if<boost::is_same<T, bool> >::type* /*unused*/ = 0,
      typename boost::disable_if<boost::has_right_shift<std::istream, typename type_traits::BuiltinType<T>::ValueType&> >::type* /*unused*/
      = 0);
   ...
   */
  template <typename T>
  static void write(std::ostream& stream, const typename type_traits::BuiltinType<T>::ValueType& value,
                    typename boost::enable_if<boost::is_same<T, bool> >::type* /*unused*/ = 0);
  ...
  static void write(std::ostream& stream, const typename type_traits::BuiltinType<T>::ValueType& value,
                    typename boost::disable_if<boost::is_same<T, bool> >::type* /*unused*/ = 0,
                    typename boost::enable_if<
                        boost::has_left_shift<std::ostream, const typename type_traits::BuiltinType<T>::ValueType&> >::type* /*unused*/
                    = 0);
